<nav x-data="{ open: false, masterOpen: false }" class="bg-white border-b border-gray-100">
...
<style>
    ...
    @media (max-width: 640px) {
        ...
        /* Master dropdown button styling */
        [x-show="masterOpen"] {
        ...
        /* Make sure responsive links are properly spaced */
        .responsive-nav-link {
